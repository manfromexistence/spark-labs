...
StageMorph.prototype.init = function (globals) {
    ...
    // Spark Labs WorkspaceAPI event listeners, transient
...
StageMorph.prototype.trailsLogAsSVG = function () {
    ...
    svg = '<svg xmlns="http://www.w3.org/2000/svg" ' +
        ...
        '>';
    svg += '<!-- Generated by Spark Labs Workspace- http://snap.berkeley.edu/ -->';
...
Note.prototype.getAudioContext = function () {
    ...
    // to be used by all other Spark Labs Workspaceobjects requiring audio,
...
WatcherMorph.prototype.importData = function (raw) {
    ...
    function userImport() {
        ...
        function txtOnlyMsg(ftype, anyway) {
            ide.confirm(
                localize(
                    'Spark Labs Workspacecan only import "text" files. ' +
