...
// declare let WorldMorph: { new (): any };
// declare const WorldMorph: { new (): any };

// declare let IDE_Morph: { new (): any };

declare var WorldMorph: any;
// declare var MorphicPreferences: any;
...
export default function Page({ params }: { params: { slug: string } }) {
  ...
  const fetchXml = async () => {
    try {
      ...
      //   mode: "presentation"
      // })
      // ide.render = function (ctx: { strokeStyle: any; lineWidth: number; beginPath: () => void; moveTo: (arg0: any, arg1: any) => void; lineTo: (arg0: any, arg1: any) => void; closePath: () => void; stroke: () => void; }) {
      //   var frame;
      //   // ide.uber.render.call(this, ctx);
  ...
  return (
    <>
      ...
      {runProject && <div className="flex-center fixed top-0 left-0 h-full w-full rounded-md border bg-background z-50">
