...
export default function Home() {
  ...
  return (
    <>
      ...
      {submitBar && <div className="scale-in-ver-bottom min-h-[500px] w-[345px] rounded-md fixed bottom-12 left-[calc(50%-172.5px)] transform flex items-end bg-background">
      ...
      {navigationsBar && <div className="scale-in-ver-bottom min-h-[500px] w-[345px] rounded-md fixed bottom-12 left-[calc(50%-172.5px)] transform flex items-end bg-background">
        {/* <div className="h-full w-full p-3 border rounded-md flex flex-col space-y-3 pb-12 !font-mono !tracking-tighter">
          <Link href='/profile' className="flex items-center w-full justify-between p-3 border rounded-md hover:bg-primary hover:text-primary-foreground">
            <span>Github</span>
            <Github className="h-4 w-4" />
      ...
      {detailsBar && <div className="scale-in-ver-bottom min-h-[500px] w-[345px] rounded-md fixed bottom-12 left-[calc(50%-172.5px)] transform flex items-end bg-background">
        {/* <div className="h-full w-full p-3 border rounded-md flex flex-col space-y-3 pb-12 !font-mono !tracking-tighter">
          <Link href='/profile' className="flex items-center w-full justify-between p-3 border rounded-md hover:bg-primary hover:text-primary-foreground">
            <span>Github</span>
            <Github className="h-4 w-4" />
      ...
      {developerBar && <div className="scale-in-ver-bottom min-h-[500px] w-[345px] rounded-md fixed bottom-12 left-[calc(50%-172.5px)] transform flex items-end bg-background">
        <div className="h-full w-full p-3 border rounded-md flex flex-col space-y-3 pb-12 !font-mono !tracking-tighter">
          <Link href='/profile' className="flex items-center w-full justify-between p-3 border rounded-md hover:bg-primary hover:text-primary-foreground">
            <span>Github</span>
            <Github className="h-4 w-4" />
      ...
      {actionsBar && <div className="scale-in-ver-bottom min-h-[500px] w-[345px] rounded-md fixed bottom-12 left-[calc(50%-172.5px)] transform flex items-end bg-background">
        {/* <div className="h-full w-full p-3 border rounded-md flex flex-col space-y-3 pb-12 !font-mono !tracking-tighter">
          <Link href='/profile' className="flex items-center w-full justify-between p-3 border rounded-md hover:bg-primary hover:text-primary-foreground">
            <span>Github</span>
            <Github className="h-4 w-4" />
