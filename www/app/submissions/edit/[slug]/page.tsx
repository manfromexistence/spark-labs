...
export default function HomePage() {
    ...
    return (
        <div className="flex min-h-screen w-full items-center justify-center relative">
            <img src="./reshot-illustration-web-designer-at-work-F7S5G9VKH4.png" className="h-full w-full" />
            <span className="absolute top-12 left-1/2 transform -translate-x-1/2 -translate-y-1/2 font-bold text-5xl text-center text-background">Submissions page is still in development!!!</span>
        </div>
    )
}
