...
//   hideControls?: boolean; // Optional property with default undefined
//   noExitWarning?: boolean; // Optional property with default undefined
// }
...
export default function Page({ params }: { params: { slug: string } }) {
  ...
  useEffect(() => {
    if (worldRef.current) {
      const world:any = new WorldMorph(worldRef.current);
      const ideInstance:any = new IDE_Morph({
        hideControls: true,
        noExitWarning: true,
      });
  ...
  return (
    <>
      ...
      <canvas className="max-h-[93vh] mx-auto rounded-md" id="world" tabIndex={1} ref={worldRef}></canvas>
