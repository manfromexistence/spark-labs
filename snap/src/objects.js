...
AlignmentMorph, Process, WorldMap, copyCanvas, useBlurredShadows, WHITE,
...
StageMorph.prototype.trailsLogAsSVG = function () {
    ...
    svg = '<svg xmlns="http://www.w3.org/2000/svg" ' +
        ...
        // 'style="background-color:white" ' + // for supporting backgrounds
        '>';
...
StageMorph.prototype.write = function (text, size) {
    ...
    textMorph.setColor(this.getColorDimension(2) > 50 ? WHITE : WHITE);
...
StagePickerMorph.prototype.dataRepresentation = function (data) {
    ...
    if (data instanceof SpeechBubbleMorph) {
        ...
        data.bubbleFontColor = data.isPointingRight ? WHITE : WHITE;
